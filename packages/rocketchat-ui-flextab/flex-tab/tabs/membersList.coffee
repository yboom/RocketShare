Template.membersList.helpers
	...
	canAddUser: ->
		...
		return roomData.t in ['p', 'c'] and RocketChat.authz.hasAllPermission('edit-room', this._id)#luwei creator is not necessarily able to add user anymore:roomData.u?._id is Meteor.userId()
