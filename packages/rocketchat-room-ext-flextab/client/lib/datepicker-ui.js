...
function Datepicker(lan) {
	...
	else
	{
		...
		currentText: "当月", // Display text for current month link
...
$.extend(Datepicker.prototype, {
	...
	_showDatepicker: function(input) {
		...
		if (!inst.inline) {
			...
			if ( $.effects && $.effects.effect && $.effects.effect[ showAnim ] ) {
...
var language = 0;
$.fn.datepicker = function(lan,cssz_index,options){
	...
	if(lan == 1) language = lan;
	if(cssz_index) z_index = cssz_index;
...
$.datepicker = new Datepicker(language); // singleton instance
